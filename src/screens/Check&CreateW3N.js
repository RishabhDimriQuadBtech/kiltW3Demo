...
const CheckCreateW3N = ({route, navigation }) => {
          ...
          <View style={styles.mnemonicContainer}>
            ...
            <View style={styles.mnemonicBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  copyToClipboard(holderMnemonic, 'Holder Mnemonic')
                }>
            ...
            {/* <View style={styles.mnemonicBox}>
              ...
              <TouchableOpacity
                style={styles.copyButton}
                onPress={() =>
                  copyToClipboard(issuerMnemonic, 'Issuer Mnemonic')
                }>
                <Text style={styles.copyButtonText}>Copy</Text>
              </TouchableOpacity>
            </View> */}
            ...
            <Text style={styles.warningText}>
              ⚠️ Important: Save these mnemonics securely. They provide access
              to your accounts.
            </Text>
          </View>
        )}
